...
namespace Library {
    ...
    public partial class DataSet2 : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsersRow AddUsersRow(bool Status, string Fullname, string Username, string Email, string Password, int Level) {
...
namespace Library.DataSet2TableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Users] WHERE (([UserID] = @Original_UserID) AND ([Status] = @Original_Status) AND ([Fullname] = @Original_Fullname) AND ([Username] = @Original_Username) AND ([Email] = @Original_Email) AND ([Password] = @Original_Password) AND ([Level] = @Original_Level))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Users] ([Status], [Fullname], [Username], [Email], [Password], [Level]) VALUES (@Status, @Fullname, @Username, @Email, @Password, @Level);
SELECT UserID, Status, Fullname, Username, Email, Password, Level FROM Users WHERE (UserID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [Status] = @Status, [Fullname] = @Fullname, [Username] = @Username, [Email] = @Email, [Password] = @Password, [Level] = @Level WHERE (([UserID] = @Original_UserID) AND ([Status] = @Original_Status) AND ([Fullname] = @Original_Fullname) AND ([Username] = @Original_Username) AND ([Email] = @Original_Email) AND ([Password] = @Original_Password) AND ([Level] = @Original_Level));
SELECT UserID, Status, Fullname, Username, Email, Password, Level FROM Users WHERE (UserID = @UserID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserID, Status, Fullname, Username, Email, Password, [Level] FROM dbo.User" +
                "s";
        ...
        public virtual int Delete(int Original_UserID, bool Original_Status, string Original_Fullname, string Original_Username, string Original_Email, string Original_Password, int Original_Level) {
        ...
        public virtual int Insert(bool Status, string Fullname, string Username, string Email, string Password, int Level) {
        ...
        public virtual int Update(bool Status, string Fullname, string Username, string Email, string Password, int Level, int Original_UserID, bool Original_Status, string Original_Fullname, string Original_Username, string Original_Email, string Original_Password, int Original_Level, int UserID) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(bool Status, string Fullname, string Username, string Email, string Password, int Level, int Original_UserID, bool Original_Status, string Original_Fullname, string Original_Username, string Original_Email, string Original_Password, int Original_Level) {
            return this.Update(Status, Fullname, Username, Email, Password, Level, Original_UserID, Original_Status, Original_Fullname, Original_Username, Original_Email, Original_Password, Original_Level, Original_UserID);
        }
    }
